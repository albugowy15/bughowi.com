...
If you're interested in starting your own Neovim journey but don't want to start from absolute zero, I've got you covered! I've shared all my configuration files (including my Neovim setup) in my dotfiles repository on GitHub: [https://github.com/albugowy15/dots](https://github.com/albugowy15/dots).
