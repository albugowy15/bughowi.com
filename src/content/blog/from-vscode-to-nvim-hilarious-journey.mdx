...
But then I stumbled upon <Link href="https://www.youtube.com/@ThePrimeagen" external={true}>ThePrimeagen's YouTube channel</Link>. Watching him use Vim was like watching a pianist play Mozart – it was beautiful, efficient, and kind of made me feel bad about my own skills. This guy was editing code faster than I could think, and I wanted in on that magic.
...
When I finally decided to try Neovim, I started with a Neovim distribution called <Link href="https://www.lazyvim.org/" external={true}>LazyVim</Link>. LazyVim is a preconfigured setup that includes various plugins, keymaps, and features. This distribution spared me from the complex manual setup, allowing me to use Neovim as an IDE right away.
...
If you're interested in starting your own Neovim journey but don't want to start from absolute zero, I've got you covered! I've shared all my configuration files (including my Neovim setup) in my dotfiles repository on GitHub: <Link href="https://github.com/albugowy15/dots" external={true}>https://github.com/albugowy15/dots</Link>.
