...
1. Create a free Cloudflare account at <Link href="https://cloudflare.com" external={true}>Cloudflare</Link>
...
The installation process is straightforward. Following the official documentation at <Link href="https://docs.dokploy.com/docs/core/installation" external={true}>Dokploy Docs</Link>, run the installation command on your VPS:
...
My personal blog (https://github.com/albugowy15/bughowi.com) is containerized with Docker, and I publish images to GitHub Container Registry. This makes deployment through Dokploy straightforward.
...
- <Link href="https://www.youtube.com/watch?v=ELkPcuO5ebo" external={true}>
    Dokploy is my absolute favorite way to deploy to a VPS in 2025 by
    dreamsofcode
  </Link>
  - This video introduced me to Dokploy and showed me how powerful it can be for
  deploying applications to a VPS.
- <Link href="https://www.youtube.com/watch?v=Q1Y_g0wMwww" external={true}>
    Self Host 101 - Set up and Secure Your Own Server by Syntax
  </Link>
  - A comprehensive walkthrough of securing a VPS that covers many of the
  security hardening steps I followed in this guide.
