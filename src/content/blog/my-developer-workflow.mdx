...
![Debian Linux Home](https://res.cloudinary.com/bughowi-assets/image/upload/q_auto/debian-linux-home.png)
![Debian Linux Home](https://res.cloudinary.com/bughowi-assets/image/upload/q_auto/neofetch-debian.png)
...
![Neovim with Telescope Plugin](https://res.cloudinary.com/bughowi-assets/image/upload/q_auto/my-neovim-with-telescope-plugin.png)
![Neovim error highlighting with trouble plugin and LSP](https://res.cloudinary.com/bughowi-assets/image/upload/q_auto/my-neovim-trouble-with-lsp.png)
![LazyGit inside neovim](https://res.cloudinary.com/bughowi-assets/image/upload/q_auto/lazygit-with-neovim.png)
...
![My alacritty with tmux configuration](https://res.cloudinary.com/bughowi-assets/image/upload/q_auto/my-alacritty-with-tmux-setup.png)
![Tmux list all sessions](https://res.cloudinary.com/bughowi-assets/image/upload/q_auto/tmux-list-all-sessions.png)
...
![Starship Go Project](https://res.cloudinary.com/bughowi-assets/image/upload/q_auto/starship-go-project.png)
![Starship Node Project](https://res.cloudinary.com/bughowi-assets/image/upload/q_auto/starship-node-project.png)
![Starship Rust Project](https://res.cloudinary.com/bughowi-assets/image/upload/q_auto/starship-rust-project.png)
![Starship Flutter Project](https://res.cloudinary.com/bughowi-assets/image/upload/q_auto/starship-flutter-project.png)
