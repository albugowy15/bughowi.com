...
5. After verifying your email, you can log in to your account.
...
Inside the function, the first thing it does is call the `preventDefault` method on the event object to prevent the page from refreshing when the form is submitted. Then it changes the state of the form to `Form.Loading`
