...
The first step is to install the `rehype-toc` plugin created by <Link href="https://www.npmjs.com/package/@jsdevtools/rehype-toc" external={true}>jsdevtools</Link>. You can install it with this command.
