...
This project is a part of the <Link href="https://github.com/albugowy15/informatics-frs-helper" external={true}>Informatics FRS Helper</Link> project to automatically parse all class schedule from Excel files to MySQL database.
...
Here is the link to the repository of this project: <Link href="https://github.com/albugowy15/auto-frs-schedule" external={true}>https://github.com/albugowy15/auto-frs-schedule</Link>
...
<div class="relative overflow-hidden w-full pt-[56.25%]">
  <iframe
    ...
    src="https://www.youtube.com/embed/ZZYkbBCab1o"
  ></iframe>
</div>
