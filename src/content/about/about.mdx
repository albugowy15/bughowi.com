...
import { SOCIAL_MEDIA } from "@/lib/constant";
...
- X: <Link href={SOCIAL_MEDIA.x.href} external={true}>{SOCIAL_MEDIA.x.username}</Link>
- Github: <Link href={SOCIAL_MEDIA.github.href} external={true}>{SOCIAL_MEDIA.github.username}</Link>
- Linkedin: <Link href={SOCIAL_MEDIA.linkedin.href} external={true}>{SOCIAL_MEDIA.linkedin.username}</Link>
