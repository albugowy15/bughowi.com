...
const Navbar = () => {
	...
	return (
		<nav className={`${onTop ? "" : "sm:drop-shadow-md"} p-1 w-full sm:p-0 sticky sm:bg-darkPrimary top-0 z-50`}>
			<div className={`${onTop ? "" : "bg-darkPrimary bg-opacity-95 shadow-black shadow-md rounded-md"} container 2xl:max-w-7xl px-4 xl:px-14 mx-auto sm:rounded-none sm:shadow-none`}>
