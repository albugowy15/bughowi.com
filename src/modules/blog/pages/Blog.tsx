...
export default function Blog({ posts, featuredPost }: { posts: Post[]; featuredPost: Post }) {
	const ogProperties = useOpenGraph({
		...
		description: "Here I share my thoughts related to front end development topics and programming in general",
		type: "website",
		...
		<>
          ...
          development topics and programming in general."
			...
			<p className="text-center py-3 mb-4 text-lg">
				Welcome to my Blog. Here I share my thoughts related to front end development topics and programming in general. I&apos;ve always been a fan of writing, and I hope you can find something here that could help you in your developer
				career.
			</p>
