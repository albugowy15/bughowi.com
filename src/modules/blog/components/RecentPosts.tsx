...
const RecentPosts = ({ posts }: { posts: Post[] }) => {
	return (
		<motion.section initial={{ opacity: 0.1, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ type: "spring", duration: 1 }} viewport={{ once: true }} id="recent-posts" className="scroll-my-16">
			<Link href="/blog">
