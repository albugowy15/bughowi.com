		...
		<>
			...
			<div>
				...
				<div id='content-space' className='py-3 w-full lg:w-[65%] mx-auto'>
					...
					<h3 className='font-bold text-xl'>Front End Engineer - Torche Education</h3>
					<p className='text-gray-400 mt-0'>December 2022 - Present</p>
					<p className='mt-2'>Create a new landing page and migrate to MERN (MongoDB, Express, React, Node.js) stack. Develope the landing page with Next.js, TypeScript, and Tailwind</p>
					<h3 className='font-bold text-xl'>Full Stack Developer - Harisenin.com</h3>
					<p className='text-gray-400'>September 2022 - December 2022</p>
					<p className='mt-2'>Working for company internal dashboard to create or improve a feature using PHP, Laravel, TypeScript, Next.js, jQuery, MUI, and MySQL</p>
