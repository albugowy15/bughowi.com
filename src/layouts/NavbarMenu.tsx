        ...
        <AnimatePresence>
          {openMenu && (
            <motion.div
              ...
              className="md:hidden z-50 flex flex-col items-center justify-center fixed right-0 left-0 bottom-0 overflow-hidden top-0 bg-background/80 backdrop-blur-md"
            >
              <motion.div
