...
Creat a schema for your MDX content. To do this, you need to create a new file called `contentlayer.config.ts{:ts}` in root folder of Next.js project. Here I create a schema for my blog post content.
