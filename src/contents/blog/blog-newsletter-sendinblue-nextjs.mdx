...
Create `.env{:sh}` file in root folder of your project. In the .env file, add a new variable called `SENDINBLUE_API_KEY{:js}` and set it to your Sendinblue API key. For example:
