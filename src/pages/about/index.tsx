      ...
      >
        ...
        <div id="content-space" className="py-3 w-full lg:w-[65%] mx-auto">
          ...
          <p>
            ...
            popular framework such as React.js, Next.js and Laravel. At the end
            I prefer to choose JavaScript as my favorite language to build a
            website.
          </p>
          <p>
            ...
            practice all the new things I just learn.
          </p>
          ...
          <p>
            ...
            you. It is basically a JavaScript typed superset that collates to
            raw JavaScript. The choice of TypeScript over JavaScript make me
            possible to remove certain anomalies earlier during the development
            phase and secure the code before going into production.
          </p>
          <h3 className="font-bold text-xl pt-2">
            <span className="mr-2">
          ...
          <p>
            ...
            File system routing feature. The data fetching (SSG, SSR, ISR) is
            also powerful feature that I really love to use it in Next.js. But
            possibly I will learn another Javascript framework such as Angular
            or Vue.js in the future.
          </p>
          <h3 className="font-bold text-xl pt-2">
            <span className="mr-2">
          ...
          <p>
            ...
            because Tailwind is really awesome. And I couldn&apos;t imagine how
            I build a website without Tailwind.
          </p>
